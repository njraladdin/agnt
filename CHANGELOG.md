...
- **Browser Automation**
  ...
  - Added `execute_js_script` tool for extracting structured data from pages via JavaScript
  - Added `save_result_as_artifact` option to `BrowserTool` for storing tool results as JSON artifacts
...
- Add support for running python main function in UnsafeLocalCodeExecutor when the code has an if **name** == "**main**" statement. ([95e33ba](https://github.com/google/adk-python/commit/95e33baf57e9c267a758e08108cde76adf8af69b))
